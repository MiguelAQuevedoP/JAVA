...
public class operacion {
    ...
    public void operations(){
        ...
        System.out.println("Segundo numero complejo: z = "+c+"+"+"j"+d);
        boolean flag = true;
        while(flag){
            ...
            switch(option){
                ...
                case 3: 
                    real = (a*c)-(b*d);
                    complejo = (a*d+b*c);
                    System.out.println("resultado producto : z = "+real+"+"+complejo+"j");
                    break;
                case 4: 
                    real = ((a*c)+(b*d))/((c*c)+(d*d));
                    complejo = ((b*c)-(a*d))/((c*c)+(d*d));
                    System.out.println("resultado division : z = "+real+"+"+complejo+"j");
                    break;
                case 5:
                flag = false;
