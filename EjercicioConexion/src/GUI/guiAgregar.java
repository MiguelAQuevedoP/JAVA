...
public class guiAgregar extends javax.swing.JFrame {
    ...
    public guiAgregar() {
        ...
        clientedao= new clsClienteDAO();
            jTextField1.setText("*** Agregue la cedula***");
            jTextField2.setText("*** Agregue el nombre***");
            jTextField3.setText("*** Agregue el email**** ");
    }
    ...
    public void guardar(){
       String nombre =  jTextField2.getText();
        ...
        this.clientedao.AgregarCliente(this.cliente);
    }
