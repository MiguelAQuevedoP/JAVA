...
public class JPanelEmpleado extends JPanel implements IGestion {
	...
	setLayout(new BorderLayout(0, 0));
		...
		panelCentral.add(cmbAñosExperiencia);
			...
			gl_panelCentral.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelCentral.createSequentialGroup()
					...
					.addGroup(gl_panelCentral.createParallelGroup(Alignment.TRAILING)
						.addComponent(cmbAñosExperiencia, Alignment.LEADING, 0, 116, Short.MAX_VALUE)
						.addComponent(dcFechaNacimiento, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE)
						.addGroup(Alignment.LEADING, gl_panelCentral.createSequentialGroup()
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(cmbTipoCargo, 0, 116, Short.MAX_VALUE))
						.addComponent(txtSueldo, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE)
						.addComponent(txtSexo, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE)
						.addGroup(Alignment.LEADING, gl_panelCentral.createSequentialGroup()
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(gl_panelCentral.createParallelGroup(Alignment.LEADING)
...
public void crearEmpleado (){
	...
	try {
		...
		objP.setSexo(this.txtSexo.getText());
