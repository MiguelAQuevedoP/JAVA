...
public class Cliente_vista extends javax.swing.JFrame {
    ...
    cliente objCliente= new cliente("localhost", 5000);
    ...
    public String Consultar(Long cedula) throws IOException { 
        String respuesta="";
                try {
        objCliente.crearConexion();
        respuesta=objCliente.consultarCliente(cedula);
