 ...
 * @author Acer
 */
public class Arcanine extends Fuego{
    public Arcanine(eNombre nombrePokemon, String descripcionPokemon, double pesoPokemon, double alturaPokemon, eGenero genero, int numeroPokemon, float puntosSalud, int puntosCombate, eTipo debilidad, eTipo fortaleza, int nivelPokemon, ArrayList<Ataque> listaAtaques) {
    ...
    public Arcanine(eNombre nombrePokemon, String descripcionPokemon, double pesoPokemon, double alturaPokemon, int numeroPokemon, eGenero genero, eTipo debilidad, eTipo fortaleza, int nivelPokemon) {
