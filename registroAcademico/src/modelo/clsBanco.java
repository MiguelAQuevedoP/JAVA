...
public class clsBanco {
	...
	public void crearEmpleado(long cedula, String nombre, eTipoSexo sexo, Calendar fechaNacimiento, double sueldo, int anosExperiencia, eTipoCargo cargo ){
		clsEmpleado objEmpleado = new clsEmpleado(cedula, nombre, sexo, fechaNacimiento, sueldo, anosExperiencia, cargo);
