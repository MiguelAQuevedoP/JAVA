...
public void inciarComponentes () {
			...
			.addGroup(gl_panelIzquierdo.createSequentialGroup()
				.addGroup(gl_panelIzquierdo.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panelIzquierdo.createParallelGroup(Alignment.TRAILING, false)
						.addComponent(btnCuenta, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(btnCliente, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE))
					.addComponent(btnEmpleados, GroupLayout.DEFAULT_SIZE, 109, Short.MAX_VALUE)
					.addComponent(btnInforme, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE))
				.addContainerGap())
	);
 ...
 public void registrarCliente (){
	 ...
	 this.panelCentral.remove(this.panelEmpleado);
