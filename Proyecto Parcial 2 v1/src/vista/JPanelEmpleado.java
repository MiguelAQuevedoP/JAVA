...
public class JPanelEmpleado extends JPanel {
	...
	private JTextField txtAñoExperiencia;
	...
	public void iniciarComponentes(){
		...
		txtAñoExperiencia = new JTextField();
		txtAñoExperiencia.setBounds(213, 232, 116, 20);
		panelCentral.add(txtAñoExperiencia);
		txtAñoExperiencia.setColumns(10);
	...
	public void crearEmpleado(){
		...
		int añoExperiencia = (Integer.parseInt(this.txtAñoExperiencia.getText()));
		eTipoCargo cargo = ((eTipoCargo)this.cmbCargoEmpleado.getSelectedItem());
		this.auxBanco.crearEmpleado(cedula, nombre,sexo, fechaNacimiento, sueldo, añoExperiencia, cargo);
		JOptionPane.showMessageDialog(this, "Cliente registrado con éxito","",JOptionPane.INFORMATION_MESSAGE);
		}
	...
	public void limpiarCampos(){
		...
		this.txtAñoExperiencia.setText("");
