 ...
 * @author migue
 */
public class JPanelBuscarCilindraje extends JPanel {
    ...
    public void iniciarComponentes() {
        ...
        JLabel lblPlaca = new JLabel("DIGITE CILINDRAJE:");
                        ...
                        .addGroup(gl_panelCentral.createSequentialGroup()
                                ...
                                .addGroup(gl_panelCentral.createParallelGroup(Alignment.LEADING, false)
                                        .addGroup(gl_panelCentral.createSequentialGroup()
                                                ...
                                                .addGap(18)
                                                .addComponent(txtCilindraje, GroupLayout.PREFERRED_SIZE, 123, GroupLayout.PREFERRED_SIZE)
                                                .addGap(57)
                ...
                gl_panelCentral.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_panelCentral.createSequentialGroup()
                                ...
                                .addGroup(gl_panelCentral.createParallelGroup(Alignment.BASELINE)
                                        ...
                                        .addComponent(txtCilindraje, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
    ...
    public void cargarTablaVehiculo() {
        ...
        for (int i = 0; i < this.lstVehiculos.size(); i++) {
            System.out.println("entrada de ciclo "+i);
            if (cilindraje==this.lstVehiculos.get(i).getCilindraje()) {
                
                System.out.println("entrada de condicional "+i);
                matriz[counter][0] = this.lstVehiculos.get(i).getPlaca();
                matriz[counter][1] = this.lstVehiculos.get(i).getColor();
                matriz[counter][2] = this.lstVehiculos.get(i).getCilindraje();
                matriz[counter][3] = this.lstVehiculos.get(i).getCaja();
                matriz[counter][4] = this.lstVehiculos.get(i).getPuertas();
        ...
        //JOptionPane.showMessageDialog(this,"VEHICULO NO ENCONTRADO", "Información",  JOptionPane.INFORMATION_MESSAGE);
    }
