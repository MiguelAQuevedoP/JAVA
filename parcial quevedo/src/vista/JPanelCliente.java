...
public class JPanelCliente extends JPanel implements IGestion{
					...
					.addGroup(gl_panelCentral.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panelCentral.createSequentialGroup()
							...
							.addGroup(gl_panelCentral.createParallelGroup(Alignment.LEADING, false)
								...
								.addComponent(dcFechaNacimiento, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 88, Short.MAX_VALUE)
								.addComponent(cmbSexo, Alignment.TRAILING, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
					.addGap(79))
		);
	...
	public void registrarCliente(){
		...
		try {
			...
			objC.setSexo((eSexo)this.cmbSexo.getSelectedItem());
	...
	public void limpiarComponentes() {
		...
		this.cmbSexo.setSelectedItem(0);
